...
def model_uncertainty(model, x_test, x_train, y_train, unc_method="bays", laplace_smoothing=1, log=False): #laplace_smoothing=0 for faster
...
# it contains all but we only kept aleatoric and only bayes model to calculate it
# before calculating uncertainty we calculate likelihood for all trees and probability matrix for each test 
